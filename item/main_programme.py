...
# input dialog 1
calculation=('Des','Opt')
calculation_target=input('Which target do you want to choose? design/best case or optimization (Des/Opt): ')
while calculation_target not in calculation:
    calculation_target=input(('Which target do you want to choose? design/best case or optimization (Des/Opt): '))
if calculation_target==calculation[0]:
